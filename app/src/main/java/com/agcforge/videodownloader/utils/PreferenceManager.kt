...
<<<<<<< HEAD
    ...
    suspend fun getIsOpenPremiumFeatureDialog(): Boolean {
        return isOpenPremiumFeatureDialog.first()
    }

    suspend fun removeIsOpenPremiumFeatureDialog() {
        context.dataStore.edit { preferences ->
            preferences.remove(IS_OPEN_PREMIUM_FEATURE_DIALOG_KEY)
        }
    }
