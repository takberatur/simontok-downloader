...
interface ApiService {
	...
	@POST("mobile-client/errors")
	suspend fun reportError(@Body request: Map<String, String>): Response<ApiResponse<Any>>

	@POST("mobile-client/protected-mobile/subscriptions")
	suspend fun upsertSubscription(@Body request: SubscriptionUpsertRequest): Response<ApiResponse<Subscription>>
